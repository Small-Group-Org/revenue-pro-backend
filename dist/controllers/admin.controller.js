...
class AdminController {
    constructor() {
        ...
        this.updateUsersLoginStatus = async (req, res) => {
            try {
        ...
        this.triggerOpportunitySync = async (req, res) => {
            try {
        ...
        this.triggerMultiClientOpportunitySync = async (req, res) => {
            try {
                const userId = req.context.getUserId();
                // Check if cron is already running
        ...
        this.triggerLeadSheetsSync = async (req, res) => {
            try {
                const userId = req.context.getUserId();
                // Check if cron is already running
