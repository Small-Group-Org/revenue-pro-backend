export class DateUtils {
    ...
    static getMonthWeeks(startDateStr, endDateStr) {
    ...
    static countDaysInRange(weekStart, weekEnd, monthStart, monthEnd) {
     ...
     */
    static getProperMonthWeeks(startDateStr, endDateStr) {
        const startDate = new Date(startDateStr);
        const endDate = new Date(endDateStr);
     ...
     */
    static getProperDateRange(startDateStr, endDateStr, queryType) {
        const startDate = new Date(startDateStr);
        const endDate = new Date(endDateStr);
        let properStartDate;
        let properEndDate;
     ...
     */
    static countDaysInPeriod(weekStart, weekEnd, targetDate, queryType) {
        let count = 0;
        const currentDate = new Date(weekStart);
        while (currentDate <= weekEnd) {
     ...
     */
    static adjustStartDateForWeekBoundary(startDateStr, queryType) {
     ...
     */
    static adjustEndDateForWeekBoundary(endDateStr, queryType) {
