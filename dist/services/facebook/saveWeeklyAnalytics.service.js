 ...
 */
export async function saveWeeklyAnalyticsToDb({ clientId, adAccountId, startDate, endDate, accessToken }) {
 ...
 */
export async function getSavedWeeklyAnalytics({ clientId, startDate, endDate }) {
