...
const fbWeeklyAnalyticsSchema = new Schema<IFbWeeklyAnalyticsDocument>(
  {
    // Client & Account Info
...
export default model<IFbWeeklyAnalyticsDocument>('FbWeeklyAnalytics', fbWeeklyAnalyticsSchema);
